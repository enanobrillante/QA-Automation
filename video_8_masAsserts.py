...
class newTours(unittest.TestCase):
    ...
    def test_dropDown(self):
        ...
        self.assertNotEqual(countryDropDown.first_selected_option.text.strip(),"ITALY") #No debe ser italy

        #aseert true o false
        self.assertTrue(countryDropDown.first_selected_option.text.strip() == "ITALY") #se supone que lo de adentro es true, sino debe tirar un AssertionError
        self.assertFalse(countryDropDown.first_selected_option.text.strip() == "ITALY")
        time.sleep(4)
